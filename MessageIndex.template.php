		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo '
					...
					<td class="lastpost ', $color_class, '">
						<strong>', $topic['last_post']['member']['link'], '</strong><a href="', $topic['last_post']['href'], '"><img src="', $settings['images_url'], '/icons/last_post.png" alt="', $txt['last_post'], '" title="', $txt['last_post'], '" /></a><br />
