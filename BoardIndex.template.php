...
function template_main()
{
	...
	$veokontrol = mysql_num_rows(mysql_query("SELECT * FROM karakterlersikim WHERE charactername = '$forumnick'"));
	if($veokontrol == 1)
	{
		echo'
		';
	...
	{
	 echo '
	  <div class="veo-duyuru2">
	  <i class="fa fa-warning" style="color: #f44336"></i>  Forum ile karakter entegrasyonu gerçekleştirilemiyor.
	  </div>';
	}
	}
	echo'
	<div class="veo-duyuru1">
	  <i class="fa fa-warning" style="color: #2196f3"></i>  Bakım süreci içerisinde oluşabilecek problemleri destek üzerinden belirtebilirsiniz.
	  </div>';
	echo '
	...
	foreach ($context['categories'] as $category)
	{
		// If theres no parent boards we can see, avoid showing an empty category (unless its collapsed)
			 ...
			 <td colspan="4">
												   ...
												   <div class="headercat">
			 <img src="', $settings['images_url'], '/kategori/', $category['id'], '.png" alt="category" width="100%"/>
			 </div>
					</td>
				</tr>
			</tbody>';
			...
			foreach ($category['boards'] as $board)
			{
				...
				// Show some basic information about the number of posts, etc.
					...
					<td class="stats windowbg">
						<p><span><i class="fa fa-comment" style="color: #0090e4;" aria-hidden="true"></i> ', comma_format($board['posts']), ' ', $board['is_redirect'] ? $txt['redirects'] : $txt['posts'], '</span><br />
						<i class="fa fa-book" style="color: #0090e4;" aria-hidden="true"></i> ', $board['is_redirect'] ? '' : comma_format($board['topics']) . ' ' . $txt['board_topics'], '
						</p>
					</td>
					<td class="lastpost">';
					if(empty($settings['no_avvy']) && !$board['is_redirect'] && !empty($board['last_post']['id']))
				 echo '
				 <a href="' , $scripturl , '?action=profile;u=' .$board['last_post']['member']['id']. ';type=rss" class="floatright">
				 <img alt=""  class="veo-pf-get"  src="' . (!empty($avvy[$board['last_post']['member']['id']]) ? $avvy[$board['last_post']['member']['id']] : $settings['images_url'].'/theme/guest.png') . '" />
				 </a>';
				...
				if (!empty($board['last_post']['id']))
					echo '
						<p><strong><i class="fa fa-user" style="color: #0090e4;" aria-hidden="true"></i> Gönderen: ', $board['last_post']['member']['link'] , '</br></strong><i class="fa fa-file-text" style="color: #0090e4;" aria-hidden="true"></i> ', $txt['in'], ' ', $board['last_post']['link'], '<br />
						<i class="fa fa-clock-o" style="color: #0090e4;" aria-hidden="true"></i> ', $board['last_post']['time'],'
						</p>';
				echo '
					</td>
				</tr>';
   ...
   if ($settings['show_stats_index'])
   {
      echo '
         <div class="title_barIC">
            <h4 class="titlebg">
               <span class="ie6_header floatleft">
                  <a href="', $scripturl, '?action=stats"><img class="icon" src="https://i.hizliresim.com/1GlbGA.png" alt="', $txt['forum_stats'], '" /></a>
                  ', $txt['forum_stats'], '
               </span>
            </h4>
         </div>
	...
	if ($settings['show_stats_index'])
	{
		echo '
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						<a href="', $scripturl, '?action=stats"><img class="icon" src="', $settings['images_url'], '/icons/enler.png" alt="', $txt['enler'], '" /></a>
						', $txt['enler'], '
					</span>
				</h4>
			</div>';
		   ...
		   foreach ($context['top_posters_day'] as $poster)
			  echo '
				<div class="veo-enler">
					<div>Günün En İyisi: ', $poster['link'], '   [', $poster['num_posts'], ' İleti]</div>';
		 
		   foreach ($context['top_posters_week'] as $poster)
			  echo '
					  <div>Haftanın En İyisi: ', $poster['link'], '     [', $poster['num_posts'], ' İleti]</div>';
		  

		   foreach ($context['top_posters_month'] as $poster)
			  echo '
					 <div>Ayın En İyisi: ', $poster['link'], '   [', $poster['num_posts'], ' İleti]</div></div>';
	}
	*/
	...
	<div class="haberler">
									<div class="haberfotoalan">
									<img src="Themes/trsamp/images/Haber/Haber1.png" alt="Haber1">
									</div>
									<div class="haberbaslikalan">
									<a href="#" style="color: #2196f3">Gelişim Süreci</a>
									</div>
									<div class="haberyazialan">
									Oluşturuluyor...
									</div>
									<div class="habertarihalan">
									<i class="fa fa-clock-o"></i> 20 Aralık 2018
									</div>
									
									<div class="habertagi2">
									Blog
									</div></div>
	<div class="haberler2">
									<div class="haberfotoalan">
									<img src="Themes/trsamp/images/Haber/Haber2.png" alt="Haber1">
									</div>
									<div class="haberbaslikalan">
									<a href="#" style="color: #2196f3">Ekonomi Süreci</a>
									</div>
									<div class="haberyazialan">
									Oluşturuluyor...
									</div>
									<div class="habertarihalan">
									<i class="fa fa-clock-o"></i> 6/25/2018
									</div>
									<div class="habertagi" style="color: #ce6a8c">
									Ekonomi
									</div>
									<div class="habertagi2">
	...
	<div class="haberler3">
									<div class="haberfotoalan">
									<img src="Themes/trsamp/images/Haber/404.png" alt="Haber1">
									</div>
									<div class="haberbaslikalan">
									N/A
									</div>
