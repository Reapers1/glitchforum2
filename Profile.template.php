...
function template_summary()
{
	...
	// Profil arka planının bulunduğu bölüm : veoper
	echo '
	<div style="background-color: #fff;-webkit-box-shadow: rgba(0, 0, 0, 0.0470588) 0 1px 1px;box-shadow: rgba(0, 0, 0, 0.0470588) 0 1px 1px;border: 1px solid #e1e6ef !important;">
<div id="profileview" class="flow_auto">
	
	
	<div class="veoper-profilarkaplan">
	<div class="veoper-bilgileriduzenle">
    <a href="?action=profile;area=forumprofile;u" style="color: #333"><i class="fa fa-envelope"></i> Özel Mesaj Gönder</a>
	</div>
	<div class="veoper-hareketdokumu">
    <a href="?action=profile;area=statistics;u" style="color: #333"><i class="fa fa-user"></i> Hareket Dökümünü Gör</a>
	</div>
	<div class="veoper-profilnick"><h4><font color=#fff>', $context['member']['name'],'</font></span></h4></div>
	<div class="veoper-profilavatar"><div class="veoper-profilnickarkaplan">', $context['member']['avatar']['image'], '</div></div>
		<div class="veoper-yetki">',$context['member']['group_stars'],'</div>
	</div>
	
	
	<div class="veoper-profilbasicinfo">
	<div id="basicinfo">
		<div class="profil-bilgilerkismi-veoper">
...
*/				
	...
	echo '
			...
			//Çevrim içi çevrim dışı olan kısım
			
			//Avatar altındaki içerikler ileti at arkadaş ekle
...
//Veritabanına baglan
	...
	$veritabani = @mysql_select_db('efsane');	
	$verial = mysql_fetch_array(mysql_query("select * from oyuncular where id='1' "));	
/*
//İleti sayısı yaş email gibi içerikler				
/*
...
<div id="tabs">
  <ul>
    <li><a href="#tabs-1">İstatistikler</a></li>
    <li><a href="#tabs-2">Üye İmza</a></li>
  </ul>
  <div id="tabs-1">
	...
	if ($context['user']['is_owner'] || $context['user']['is_admin'])
		echo '
					<dt> <i class="fa fa-user-circle"></i> ', $txt['username'], ': </dt>
					<dd>', $context['member']['username'], '</dd>';
	//İleti sayısı
	if (!isset($context['disabled_fields']['posts']))
		echo ' 
					<dt> <i class="fa fa-clipboard"></i> ', $txt['profile_posts'], ': </dt>
					<dd>', $context['member']['posts'], ' (', $context['member']['posts_per_day'], ' ', $txt['posts_per_day'], ')</dd>';
	//Son Aktivite
	if (isset($context['member']['action']) && allowedTo('who_view')) {
		echo '<dt> <i class="fa fa-leanpub"></i> Son Aktivite', $txt['current_activity'], ':</dt>
					<dd>', $context['member']['action'], '</dd>';
								}
	// Mail adresi görünmeyen
	if ($context['member']['show_email'] == 'yes')
		echo '
					<dt>', $txt['email'], ': </dt>
					<dd><a href="', $scripturl, '?action=emailuser;sa=email;uid=', $context['member']['id'], '">', $context['member']['email'], '</a></dd>';
	...
	elseif ($context['member']['show_email'] == 'yes_permission_override')
		echo '
					<dt> <i class="fa fa-envelope-open"></i>  ', $txt['email'], ': </dt>
					<dd><em><a href="', $scripturl, '?action=emailuser;sa=email;uid=', $context['member']['id'], '">', $context['member']['email'], '</a></em></dd>';
	//Özel Başlık
	if (!empty($modSettings['titlesEnable']) && !empty($context['member']['title']))
		echo '
					<dt> <i class="fa fa-id-card"></i> ', $txt['custom_title'], ': </dt>
					<dd>', $context['member']['title'], '</dd>';
	//Karakter adı
	if (!empty($context['member']['blurb']))
		echo '
					<dt> <i class="fa fa-id-card"></i>  ', $txt['personal_text'], ': </dt>
					<dd>', $context['member']['blurb'], '</dd>';

	// If karma enabled show the members karma.
	if ($modSettings['karmaMode'] == '1')
		echo '
					<dt> <i class="fa fa-flag"></i> ', $modSettings['karmaLabel'], ' </dt>
					<dd>', ($context['member']['karma']['good'] - $context['member']['karma']['bad']), '</dd>';
	...
	if (!isset($context['disabled_fields']['gender']) && !empty($context['member']['gender']['name']))
		echo '
					<dt> <i class="fa fa-transgender"></i> ', $txt['gender'], ': </dt>
					<dd>', $context['member']['gender']['name'], '</dd>';
	// Yaş
	echo '
					<dt> <i class="fa fa-calendar"></i>  ', $txt['age'], ':</dt>
					<dd>', $context['member']['age'] . ($context['member']['today_is_birthday'] ? ' &nbsp; <img src="' . $settings['images_url'] . '/cake.png" alt="" />' : ''), '</dd>';
	// Yer
	if (!isset($context['disabled_fields']['location']) && !empty($context['member']['location']))
		echo '
					<dt> <i class="fa fa-map"></i>  ', $txt['location'], ':</dt>
					<dd>', $context['member']['location'], '</dd>';
	...
	{
		echo '
					<dt> <i class="fa fa-exclamation-triangle"></i> ', $txt['profile_warning_level'], ': </dt>
					<dd>
...
//Kayıt Tarihi
	echo '
					<dt> <i class="fa fa-pencil"></i>  ', $txt['date_registered'], ': </dt>
	...
	if ($context['can_see_ip'])
	{
		...
		echo '
					<dt> <i class="fa fa-life-ring"></i> ', $txt['ip'], ': </dt>
					<dd><a href="', $scripturl, '?action=profile;area=tracking;sa=ip;searchip=', $context['member']['ip'], ';u=', $context['member']['id'], '">', $context['member']['ip'], '</a></dd>';
		//Host adı
		if (empty($modSettings['disableHostnameLookup']) && !empty($context['member']['ip']))
			echo '
					<dt> <i class="fa fa-microchip"></i> ', $txt['hostname'], ': </dt>
					<dd>', $context['member']['hostname'], '</dd>';
	}
	//Yerel Zaman
	echo '
					<dt> <i class="fa fa-clock-o"></i>  ', $txt['local_time'], ':</dt>
					<dd>', $context['member']['local_time'], '</dd>';
	//Dil
	if (!empty($modSettings['userLanguage']) && !empty($context['member']['language']))
		echo '
					<dt><i class="fa fa-language"></i> ', $txt['language'], ':</dt>
					<dd>', $context['member']['language'], '</dd>';
	//Son Aktif Olma Zamanı
	echo '
					<dt> <i class="fa fa-sign-in"></i>  ', $txt['lastLoggedIn'], ': </dt>
  ...
  <div id="tabs-2">
	...
	//Kayıt tarihi ne zaman aktif oldu  veoper
...
<option', @$context['member']['options']['teknoromi'] == '4' ? ' selected="selected"' : '', '>4</option>
<option', @$context['member']['options']['teknoromi'] == '5' ? ' selected="selected"' : '', '>5</option>
<option', @$context['member']['options']['teknoromi'] == '6' ? ' selected="selected"' : '', '>6</option>
<option', @$context['member']['options']['teknoromi'] == '7' ? ' selected="selected"' : '', '>7</option>
<option', @$context['member']['options']['teknoromi'] == '8' ? ' selected="selected"' : '', '>8</option>
<option', @$context['member']['options']['teknoromi'] == '9' ? ' selected="selected"' : '', '>9</option>
<option', @$context['member']['options']['teknoromi'] == '10' ? ' selected="selected"' : '', '>10</option>
<option', @$context['member']['options']['teknoromi'] == '11' ? ' selected="selected"' : '', '>11</option>
<option', @$context['member']['options']['teknoromi'] == '12' ? ' selected="selected"' : '', '>12</option>
<option', @$context['member']['options']['teknoromi'] == '13' ? ' selected="selected"' : '', '>13</option>
<option', @$context['member']['options']['teknoromi'] == '14' ? ' selected="selected"' : '', '>14</option>
<option', @$context['member']['options']['teknoromi'] == '15' ? ' selected="selected"' : '', '>15</option>
<option', @$context['member']['options']['teknoromi'] == '16' ? ' selected="selected"' : '', '>16</option>
<option', @$context['member']['options']['teknoromi'] == '17' ? ' selected="selected"' : '', '>17</option>
<option', @$context['member']['options']['teknoromi'] == '18' ? ' selected="selected"' : '', '>18</option>
<option', @$context['member']['options']['teknoromi'] == '19' ? ' selected="selected"' : '', '>19</option>
<option', @$context['member']['options']['teknoromi'] == '20' ? ' selected="selected"' : '', '>20</option>
<option', @$context['member']['options']['teknoromi'] == '21' ? ' selected="selected"' : '', '>21</option>
<option', @$context['member']['options']['teknoromi'] == '22' ? ' selected="selected"' : '', '>22</option>
<option', @$context['member']['options']['teknoromi'] == '23' ? ' selected="selected"' : '', '>23</option>
<option', @$context['member']['options']['teknoromi'] == '24' ? ' selected="selected"' : '', '>24</option>
<option', @$context['member']['options']['teknoromi'] == '25' ? ' selected="selected"' : '', '>25</option>
<option', @$context['member']['options']['teknoromi'] == '26' ? ' selected="selected"' : '', '>26</option>
<option', @$context['member']['options']['teknoromi'] == '27' ? ' selected="selected"' : '', '>27</option>
<option', @$context['member']['options']['teknoromi'] == '28' ? ' selected="selected"' : '', '>28</option>
<option', @$context['member']['options']['teknoromi'] == '29' ? ' selected="selected"' : '', '>29</option>
<option', @$context['member']['options']['teknoromi'] == '30' ? ' selected="selected"' : '', '>30</option>
<option', @$context['member']['options']['teknoromi'] == '31' ? ' selected="selected"' : '', '>31</option>
<option', @$context['member']['options']['teknoromi'] == '32' ? ' selected="selected"' : '', '>32</option>
<option', @$context['member']['options']['teknoromi'] == '33' ? ' selected="selected"' : '', '>33</option>
<option', @$context['member']['options']['teknoromi'] == '34' ? ' selected="selected"' : '', '>34</option>
<option', @$context['member']['options']['teknoromi'] == '35' ? ' selected="selected"' : '', '>35</option>
<option', @$context['member']['options']['teknoromi'] == '36' ? ' selected="selected"' : '', '>36</option>
<option', @$context['member']['options']['teknoromi'] == '37' ? ' selected="selected"' : '', '>37</option>
<option', @$context['member']['options']['teknoromi'] == '38' ? ' selected="selected"' : '', '>38</option>
<option', @$context['member']['options']['teknoromi'] == '39' ? ' selected="selected"' : '', '>39</option>
<option', @$context['member']['options']['teknoromi'] == '40' ? ' selected="selected"' : '', '>40</option>
<option', @$context['member']['options']['teknoromi'] == '41' ? ' selected="selected"' : '', '>41</option>
<option', @$context['member']['options']['teknoromi'] == '42' ? ' selected="selected"' : '', '>42</option>
<option', @$context['member']['options']['teknoromi'] == '43' ? ' selected="selected"' : '', '>43</option>
<option', @$context['member']['options']['teknoromi'] == '44' ? ' selected="selected"' : '', '>44</option>
<option', @$context['member']['options']['teknoromi'] == '45' ? ' selected="selected"' : '', '>45</option>
<option', @$context['member']['options']['teknoromi'] == '46' ? ' selected="selected"' : '', '>46</option>
<option', @$context['member']['options']['teknoromi'] == '47' ? ' selected="selected"' : '', '>47</option>
<option', @$context['member']['options']['teknoromi'] == '48' ? ' selected="selected"' : '', '>48</option>
<option', @$context['member']['options']['teknoromi'] == '49' ? ' selected="selected"' : '', '>49</option>
<option', @$context['member']['options']['teknoromi'] == '50' ? ' selected="selected"' : '', '>50</option>
<option', @$context['member']['options']['teknoromi'] == '51' ? ' selected="selected"' : '', '>51</option>
<option', @$context['member']['options']['teknoromi'] == '52' ? ' selected="selected"' : '', '>52</option>
<option', @$context['member']['options']['teknoromi'] == '54' ? ' selected="selected"' : '', '>54</option>
<option', @$context['member']['options']['teknoromi'] == '55' ? ' selected="selected"' : '', '>55</option>
<option', @$context['member']['options']['teknoromi'] == '56' ? ' selected="selected"' : '', '>56</option>
<option', @$context['member']['options']['teknoromi'] == '57' ? ' selected="selected"' : '', '>57</option>
<option', @$context['member']['options']['teknoromi'] == '58' ? ' selected="selected"' : '', '>58</option>
<option', @$context['member']['options']['teknoromi'] == '59' ? ' selected="selected"' : '', '>59</option>
<option', @$context['member']['options']['teknoromi'] == '60' ? ' selected="selected"' : '', '>60</option>
<option', @$context['member']['options']['teknoromi'] == '61' ? ' selected="selected"' : '', '>61</option>
<option', @$context['member']['options']['teknoromi'] == '62' ? ' selected="selected"' : '', '>62</option>
<option', @$context['member']['options']['teknoromi'] == '63' ? ' selected="selected"' : '', '>63</option>
<option', @$context['member']['options']['teknoromi'] == '64' ? ' selected="selected"' : '', '>64</option>
<option', @$context['member']['options']['teknoromi'] == '65' ? ' selected="selected"' : '', '>65</option>
<option', @$context['member']['options']['teknoromi'] == '66' ? ' selected="selected"' : '', '>66</option>
<option', @$context['member']['options']['teknoromi'] == '67' ? ' selected="selected"' : '', '>67</option>
<option', @$context['member']['options']['teknoromi'] == '68' ? ' selected="selected"' : '', '>68</option>
<option', @$context['member']['options']['teknoromi'] == '69' ? ' selected="selected"' : '', '>69</option>
<option', @$context['member']['options']['teknoromi'] == '70' ? ' selected="selected"' : '', '>70</option>
<option', @$context['member']['options']['teknoromi'] == '71' ? ' selected="selected"' : '', '>71</option>
<option', @$context['member']['options']['teknoromi'] == '72' ? ' selected="selected"' : '', '>72</option>
<option', @$context['member']['options']['teknoromi'] == '73' ? ' selected="selected"' : '', '>73</option>
<option', @$context['member']['options']['teknoromi'] == '75' ? ' selected="selected"' : '', '>75</option>
<option', @$context['member']['options']['teknoromi'] == '76' ? ' selected="selected"' : '', '>76</option>
<option', @$context['member']['options']['teknoromi'] == '77' ? ' selected="selected"' : '', '>77</option>
<option', @$context['member']['options']['teknoromi'] == '78' ? ' selected="selected"' : '', '>78</option>
<option', @$context['member']['options']['teknoromi'] == '79' ? ' selected="selected"' : '', '>79</option>
<option', @$context['member']['options']['teknoromi'] == '80' ? ' selected="selected"' : '', '>80</option>
<option', @$context['member']['options']['teknoromi'] == '81' ? ' selected="selected"' : '', '>81</option>
<option', @$context['member']['options']['teknoromi'] == '82' ? ' selected="selected"' : '', '>82</option>
<option', @$context['member']['options']['teknoromi'] == '83' ? ' selected="selected"' : '', '>83</option>
<option', @$context['member']['options']['teknoromi'] == '84' ? ' selected="selected"' : '', '>84</option>
<option', @$context['member']['options']['teknoromi'] == '85' ? ' selected="selected"' : '', '>85</option>
<option', @$context['member']['options']['teknoromi'] == '86' ? ' selected="selected"' : '', '>86</option>
<option', @$context['member']['options']['teknoromi'] == '87' ? ' selected="selected"' : '', '>87</option>
<option', @$context['member']['options']['teknoromi'] == '88' ? ' selected="selected"' : '', '>88</option>
<option', @$context['member']['options']['teknoromi'] == '89' ? ' selected="selected"' : '', '>89</option>
<option', @$context['member']['options']['teknoromi'] == '90' ? ' selected="selected"' : '', '>90</option>
<option', @$context['member']['options']['teknoromi'] == '91' ? ' selected="selected"' : '', '>91</option>
<option', @$context['member']['options']['teknoromi'] == '92' ? ' selected="selected"' : '', '>92</option>
<option', @$context['member']['options']['teknoromi'] == '93' ? ' selected="selected"' : '', '>93</option>
<option', @$context['member']['options']['teknoromi'] == '94' ? ' selected="selected"' : '', '>94</option>
<option', @$context['member']['options']['teknoromi'] == '95' ? ' selected="selected"' : '', '>95</option>
<option', @$context['member']['options']['teknoromi'] == '96' ? ' selected="selected"' : '', '>96</option>
<option', @$context['member']['options']['teknoromi'] == '97' ? ' selected="selected"' : '', '>97</option>
<option', @$context['member']['options']['teknoromi'] == '98' ? ' selected="selected"' : '', '>98</option>
<option', @$context['member']['options']['teknoromi'] == '99' ? ' selected="selected"' : '', '>99</option>
<option', @$context['member']['options']['teknoromi'] == '100' ? ' selected="selected"' : '', '>100</option>
<option', @$context['member']['options']['teknoromi'] == '101' ? ' selected="selected"' : '', '>101</option>
<option', @$context['member']['options']['teknoromi'] == '102' ? ' selected="selected"' : '', '>102</option>
<option', @$context['member']['options']['teknoromi'] == '103' ? ' selected="selected"' : '', '>103</option>
<option', @$context['member']['options']['teknoromi'] == '104' ? ' selected="selected"' : '', '>104</option>
<option', @$context['member']['options']['teknoromi'] == '105' ? ' selected="selected"' : '', '>105</option>
<option', @$context['member']['options']['teknoromi'] == '106' ? ' selected="selected"' : '', '>106</option>
<option', @$context['member']['options']['teknoromi'] == '107' ? ' selected="selected"' : '', '>107</option>
<option', @$context['member']['options']['teknoromi'] == '108' ? ' selected="selected"' : '', '>108</option>
<option', @$context['member']['options']['teknoromi'] == '109' ? ' selected="selected"' : '', '>109</option>
<option', @$context['member']['options']['teknoromi'] == '110' ? ' selected="selected"' : '', '>110</option>
<option', @$context['member']['options']['teknoromi'] == '111' ? ' selected="selected"' : '', '>111</option>
<option', @$context['member']['options']['teknoromi'] == '112' ? ' selected="selected"' : '', '>112</option>
<option', @$context['member']['options']['teknoromi'] == '113' ? ' selected="selected"' : '', '>113</option>
<option', @$context['member']['options']['teknoromi'] == '114' ? ' selected="selected"' : '', '>114</option>
<option', @$context['member']['options']['teknoromi'] == '115' ? ' selected="selected"' : '', '>115</option>
<option', @$context['member']['options']['teknoromi'] == '116' ? ' selected="selected"' : '', '>116</option>
<option', @$context['member']['options']['teknoromi'] == '117' ? ' selected="selected"' : '', '>117</option>
<option', @$context['member']['options']['teknoromi'] == '118' ? ' selected="selected"' : '', '>118</option>
<option', @$context['member']['options']['teknoromi'] == '119' ? ' selected="selected"' : '', '>119</option>
<option', @$context['member']['options']['teknoromi'] == '120' ? ' selected="selected"' : '', '>120</option>
<option', @$context['member']['options']['teknoromi'] == '121' ? ' selected="selected"' : '', '>121</option>
<option', @$context['member']['options']['teknoromi'] == '122' ? ' selected="selected"' : '', '>122</option>
<option', @$context['member']['options']['teknoromi'] == '123' ? ' selected="selected"' : '', '>123</option>
<option', @$context['member']['options']['teknoromi'] == '124' ? ' selected="selected"' : '', '>124</option>
<option', @$context['member']['options']['teknoromi'] == '125' ? ' selected="selected"' : '', '>125</option>
<option', @$context['member']['options']['teknoromi'] == '126' ? ' selected="selected"' : '', '>126</option>
<option', @$context['member']['options']['teknoromi'] == '127' ? ' selected="selected"' : '', '>127</option>
<option', @$context['member']['options']['teknoromi'] == '128' ? ' selected="selected"' : '', '>128</option>
<option', @$context['member']['options']['teknoromi'] == '129' ? ' selected="selected"' : '', '>129</option>
<option', @$context['member']['options']['teknoromi'] == '130' ? ' selected="selected"' : '', '>130</option>
<option', @$context['member']['options']['teknoromi'] == '131' ? ' selected="selected"' : '', '>131</option>
<option', @$context['member']['options']['teknoromi'] == '132' ? ' selected="selected"' : '', '>132</option>
<option', @$context['member']['options']['teknoromi'] == '133' ? ' selected="selected"' : '', '>133</option>
<option', @$context['member']['options']['teknoromi'] == '134' ? ' selected="selected"' : '', '>134</option>
<option', @$context['member']['options']['teknoromi'] == '135' ? ' selected="selected"' : '', '>135</option>
<option', @$context['member']['options']['teknoromi'] == '136' ? ' selected="selected"' : '', '>136</option>
<option', @$context['member']['options']['teknoromi'] == '137' ? ' selected="selected"' : '', '>137</option>
<option', @$context['member']['options']['teknoromi'] == '138' ? ' selected="selected"' : '', '>138</option>
<option', @$context['member']['options']['teknoromi'] == '139' ? ' selected="selected"' : '', '>139</option>
<option', @$context['member']['options']['teknoromi'] == '140' ? ' selected="selected"' : '', '>140</option>
<option', @$context['member']['options']['teknoromi'] == '141' ? ' selected="selected"' : '', '>141</option>
<option', @$context['member']['options']['teknoromi'] == '142' ? ' selected="selected"' : '', '>142</option>
<option', @$context['member']['options']['teknoromi'] == '143' ? ' selected="selected"' : '', '>143</option>
<option', @$context['member']['options']['teknoromi'] == '144' ? ' selected="selected"' : '', '>144</option>
<option', @$context['member']['options']['teknoromi'] == '145' ? ' selected="selected"' : '', '>145</option>
<option', @$context['member']['options']['teknoromi'] == '146' ? ' selected="selected"' : '', '>146</option>
<option', @$context['member']['options']['teknoromi'] == '147' ? ' selected="selected"' : '', '>147</option>
<option', @$context['member']['options']['teknoromi'] == '148' ? ' selected="selected"' : '', '>148</option>
<option', @$context['member']['options']['teknoromi'] == '150' ? ' selected="selected"' : '', '>150</option>
<option', @$context['member']['options']['teknoromi'] == '151' ? ' selected="selected"' : '', '>151</option>
<option', @$context['member']['options']['teknoromi'] == '152' ? ' selected="selected"' : '', '>152</option>
<option', @$context['member']['options']['teknoromi'] == '153' ? ' selected="selected"' : '', '>153</option>
<option', @$context['member']['options']['teknoromi'] == '154' ? ' selected="selected"' : '', '>154</option>
<option', @$context['member']['options']['teknoromi'] == '155' ? ' selected="selected"' : '', '>155</option>
<option', @$context['member']['options']['teknoromi'] == '156' ? ' selected="selected"' : '', '>156</option>
<option', @$context['member']['options']['teknoromi'] == '157' ? ' selected="selected"' : '', '>157</option>
<option', @$context['member']['options']['teknoromi'] == '158' ? ' selected="selected"' : '', '>158</option>
<option', @$context['member']['options']['teknoromi'] == '159' ? ' selected="selected"' : '', '>159</option>
<option', @$context['member']['options']['teknoromi'] == '160' ? ' selected="selected"' : '', '>160</option>
<option', @$context['member']['options']['teknoromi'] == '161' ? ' selected="selected"' : '', '>161</option>
<option', @$context['member']['options']['teknoromi'] == '162' ? ' selected="selected"' : '', '>162</option>
<option', @$context['member']['options']['teknoromi'] == '163' ? ' selected="selected"' : '', '>163</option>
<option', @$context['member']['options']['teknoromi'] == '164' ? ' selected="selected"' : '', '>164</option>
<option', @$context['member']['options']['teknoromi'] == '165' ? ' selected="selected"' : '', '>165</option>
<option', @$context['member']['options']['teknoromi'] == '166' ? ' selected="selected"' : '', '>166</option>
<option', @$context['member']['options']['teknoromi'] == '167' ? ' selected="selected"' : '', '>167</option>
<option', @$context['member']['options']['teknoromi'] == '168' ? ' selected="selected"' : '', '>168</option>
<option', @$context['member']['options']['teknoromi'] == '169' ? ' selected="selected"' : '', '>169</option>
<option', @$context['member']['options']['teknoromi'] == '170' ? ' selected="selected"' : '', '>170</option>
<option', @$context['member']['options']['teknoromi'] == '171' ? ' selected="selected"' : '', '>171</option>
<option', @$context['member']['options']['teknoromi'] == '172' ? ' selected="selected"' : '', '>172</option>
<option', @$context['member']['options']['teknoromi'] == '173' ? ' selected="selected"' : '', '>173</option>
<option', @$context['member']['options']['teknoromi'] == '174' ? ' selected="selected"' : '', '>174</option>
<option', @$context['member']['options']['teknoromi'] == '175' ? ' selected="selected"' : '', '>175</option>
<option', @$context['member']['options']['teknoromi'] == '176' ? ' selected="selected"' : '', '>176</option>
<option', @$context['member']['options']['teknoromi'] == '177' ? ' selected="selected"' : '', '>177</option>
<option', @$context['member']['options']['teknoromi'] == '178' ? ' selected="selected"' : '', '>178</option>
<option', @$context['member']['options']['teknoromi'] == '179' ? ' selected="selected"' : '', '>179</option>
<option', @$context['member']['options']['teknoromi'] == '180' ? ' selected="selected"' : '', '>180</option>
<option', @$context['member']['options']['teknoromi'] == '181' ? ' selected="selected"' : '', '>181</option>
<option', @$context['member']['options']['teknoromi'] == '182' ? ' selected="selected"' : '', '>182</option>
<option', @$context['member']['options']['teknoromi'] == '183' ? ' selected="selected"' : '', '>183</option>
<option', @$context['member']['options']['teknoromi'] == '184' ? ' selected="selected"' : '', '>184</option>
<option', @$context['member']['options']['teknoromi'] == '185' ? ' selected="selected"' : '', '>185</option>
<option', @$context['member']['options']['teknoromi'] == '186' ? ' selected="selected"' : '', '>186</option>
<option', @$context['member']['options']['teknoromi'] == '187' ? ' selected="selected"' : '', '>187</option>
<option', @$context['member']['options']['teknoromi'] == '188' ? ' selected="selected"' : '', '>188</option>
<option', @$context['member']['options']['teknoromi'] == '189' ? ' selected="selected"' : '', '>189</option>
<option', @$context['member']['options']['teknoromi'] == '190' ? ' selected="selected"' : '', '>190</option>
<option', @$context['member']['options']['teknoromi'] == '191' ? ' selected="selected"' : '', '>191</option>
<option', @$context['member']['options']['teknoromi'] == '192' ? ' selected="selected"' : '', '>192</option>
<option', @$context['member']['options']['teknoromi'] == '193' ? ' selected="selected"' : '', '>193</option>
<option', @$context['member']['options']['teknoromi'] == '194' ? ' selected="selected"' : '', '>194</option>
<option', @$context['member']['options']['teknoromi'] == '195' ? ' selected="selected"' : '', '>195</option>
<option', @$context['member']['options']['teknoromi'] == '196' ? ' selected="selected"' : '', '>196</option>
<option', @$context['member']['options']['teknoromi'] == '197' ? ' selected="selected"' : '', '>197</option>
<option', @$context['member']['options']['teknoromi'] == '198' ? ' selected="selected"' : '', '>198</option>
<option', @$context['member']['options']['teknoromi'] == '199' ? ' selected="selected"' : '', '>199</option>
<option', @$context['member']['options']['teknoromi'] == '200' ? ' selected="selected"' : '', '>200</option>
<option', @$context['member']['options']['teknoromi'] == '201' ? ' selected="selected"' : '', '>201</option>
<option', @$context['member']['options']['teknoromi'] == '202' ? ' selected="selected"' : '', '>202</option>
<option', @$context['member']['options']['teknoromi'] == '203' ? ' selected="selected"' : '', '>203</option>
<option', @$context['member']['options']['teknoromi'] == '204' ? ' selected="selected"' : '', '>204</option>
<option', @$context['member']['options']['teknoromi'] == '205' ? ' selected="selected"' : '', '>205</option>
<option', @$context['member']['options']['teknoromi'] == '206' ? ' selected="selected"' : '', '>206</option>
<option', @$context['member']['options']['teknoromi'] == '207' ? ' selected="selected"' : '', '>207</option>
<option', @$context['member']['options']['teknoromi'] == '208' ? ' selected="selected"' : '', '>208</option>
<option', @$context['member']['options']['teknoromi'] == '209' ? ' selected="selected"' : '', '>209</option>
<option', @$context['member']['options']['teknoromi'] == '210' ? ' selected="selected"' : '', '>210</option>
<option', @$context['member']['options']['teknoromi'] == '211' ? ' selected="selected"' : '', '>211</option>
<option', @$context['member']['options']['teknoromi'] == '212' ? ' selected="selected"' : '', '>212</option>
<option', @$context['member']['options']['teknoromi'] == '213' ? ' selected="selected"' : '', '>213</option>
<option', @$context['member']['options']['teknoromi'] == '214' ? ' selected="selected"' : '', '>214</option>
<option', @$context['member']['options']['teknoromi'] == '215' ? ' selected="selected"' : '', '>215</option>
<option', @$context['member']['options']['teknoromi'] == '216' ? ' selected="selected"' : '', '>216</option>
<option', @$context['member']['options']['teknoromi'] == '217' ? ' selected="selected"' : '', '>217</option>
<option', @$context['member']['options']['teknoromi'] == '218' ? ' selected="selected"' : '', '>218</option>
<option', @$context['member']['options']['teknoromi'] == '219' ? ' selected="selected"' : '', '>219</option>
<option', @$context['member']['options']['teknoromi'] == '220' ? ' selected="selected"' : '', '>220</option>
<option', @$context['member']['options']['teknoromi'] == '221' ? ' selected="selected"' : '', '>221</option>
<option', @$context['member']['options']['teknoromi'] == '222' ? ' selected="selected"' : '', '>222</option>
<option', @$context['member']['options']['teknoromi'] == '223' ? ' selected="selected"' : '', '>223</option>
<option', @$context['member']['options']['teknoromi'] == '224' ? ' selected="selected"' : '', '>224</option>
<option', @$context['member']['options']['teknoromi'] == '225' ? ' selected="selected"' : '', '>225</option>
<option', @$context['member']['options']['teknoromi'] == '226' ? ' selected="selected"' : '', '>226</option>
<option', @$context['member']['options']['teknoromi'] == '227' ? ' selected="selected"' : '', '>227</option>
<option', @$context['member']['options']['teknoromi'] == '228' ? ' selected="selected"' : '', '>228</option>
<option', @$context['member']['options']['teknoromi'] == '229' ? ' selected="selected"' : '', '>229</option>
<option', @$context['member']['options']['teknoromi'] == '230' ? ' selected="selected"' : '', '>230</option>
<option', @$context['member']['options']['teknoromi'] == '231' ? ' selected="selected"' : '', '>231</option>
<option', @$context['member']['options']['teknoromi'] == '232' ? ' selected="selected"' : '', '>232</option>
<option', @$context['member']['options']['teknoromi'] == '233' ? ' selected="selected"' : '', '>233</option>
<option', @$context['member']['options']['teknoromi'] == '234' ? ' selected="selected"' : '', '>234</option>
<option', @$context['member']['options']['teknoromi'] == '235' ? ' selected="selected"' : '', '>235</option>
<option', @$context['member']['options']['teknoromi'] == '236' ? ' selected="selected"' : '', '>236</option>
<option', @$context['member']['options']['teknoromi'] == '237' ? ' selected="selected"' : '', '>237</option>
<option', @$context['member']['options']['teknoromi'] == '238' ? ' selected="selected"' : '', '>238</option>
<option', @$context['member']['options']['teknoromi'] == '239' ? ' selected="selected"' : '', '>239</option>
<option', @$context['member']['options']['teknoromi'] == '240' ? ' selected="selected"' : '', '>240</option>
<option', @$context['member']['options']['teknoromi'] == '241' ? ' selected="selected"' : '', '>241</option>
<option', @$context['member']['options']['teknoromi'] == '242' ? ' selected="selected"' : '', '>242</option>
<option', @$context['member']['options']['teknoromi'] == '243' ? ' selected="selected"' : '', '>243</option>
<option', @$context['member']['options']['teknoromi'] == '244' ? ' selected="selected"' : '', '>244</option>
<option', @$context['member']['options']['teknoromi'] == '245' ? ' selected="selected"' : '', '>245</option>
<option', @$context['member']['options']['teknoromi'] == '246' ? ' selected="selected"' : '', '>246</option>
<option', @$context['member']['options']['teknoromi'] == '247' ? ' selected="selected"' : '', '>247</option>
<option', @$context['member']['options']['teknoromi'] == '248' ? ' selected="selected"' : '', '>248</option>
<option', @$context['member']['options']['teknoromi'] == '249' ? ' selected="selected"' : '', '>249</option>
<option', @$context['member']['options']['teknoromi'] == '250' ? ' selected="selected"' : '', '>250</option>
<option', @$context['member']['options']['teknoromi'] == '251' ? ' selected="selected"' : '', '>251</option>
<option', @$context['member']['options']['teknoromi'] == '252' ? ' selected="selected"' : '', '>252</option>
<option', @$context['member']['options']['teknoromi'] == '253' ? ' selected="selected"' : '', '>253</option>
<option', @$context['member']['options']['teknoromi'] == '254' ? ' selected="selected"' : '', '>254</option>
<option', @$context['member']['options']['teknoromi'] == '255' ? ' selected="selected"' : '', '>255</option>
<option', @$context['member']['options']['teknoromi'] == '256' ? ' selected="selected"' : '', '>256</option>
<option', @$context['member']['options']['teknoromi'] == '257' ? ' selected="selected"' : '', '>257</option>
<option', @$context['member']['options']['teknoromi'] == '258' ? ' selected="selected"' : '', '>258</option>
<option', @$context['member']['options']['teknoromi'] == '259' ? ' selected="selected"' : '', '>259</option>
<option', @$context['member']['options']['teknoromi'] == '260' ? ' selected="selected"' : '', '>260</option>
<option', @$context['member']['options']['teknoromi'] == '261' ? ' selected="selected"' : '', '>261</option>
<option', @$context['member']['options']['teknoromi'] == '262' ? ' selected="selected"' : '', '>262</option>
<option', @$context['member']['options']['teknoromi'] == '263' ? ' selected="selected"' : '', '>263</option>
<option', @$context['member']['options']['teknoromi'] == '264' ? ' selected="selected"' : '', '>264</option>
<option', @$context['member']['options']['teknoromi'] == '265' ? ' selected="selected"' : '', '>265</option>
<option', @$context['member']['options']['teknoromi'] == '266' ? ' selected="selected"' : '', '>266</option>
<option', @$context['member']['options']['teknoromi'] == '267' ? ' selected="selected"' : '', '>267</option>
<option', @$context['member']['options']['teknoromi'] == '268' ? ' selected="selected"' : '', '>268</option>
<option', @$context['member']['options']['teknoromi'] == '269' ? ' selected="selected"' : '', '>269</option>
<option', @$context['member']['options']['teknoromi'] == '270' ? ' selected="selected"' : '', '>270</option>
<option', @$context['member']['options']['teknoromi'] == '271' ? ' selected="selected"' : '', '>271</option>
<option', @$context['member']['options']['teknoromi'] == '272' ? ' selected="selected"' : '', '>272</option>
<option', @$context['member']['options']['teknoromi'] == '273' ? ' selected="selected"' : '', '>273</option>
<option', @$context['member']['options']['teknoromi'] == '274' ? ' selected="selected"' : '', '>274</option>
<option', @$context['member']['options']['teknoromi'] == '275' ? ' selected="selected"' : '', '>275</option>
<option', @$context['member']['options']['teknoromi'] == '276' ? ' selected="selected"' : '', '>276</option>
<option', @$context['member']['options']['teknoromi'] == '277' ? ' selected="selected"' : '', '>277</option>
<option', @$context['member']['options']['teknoromi'] == '278' ? ' selected="selected"' : '', '>278</option>
<option', @$context['member']['options']['teknoromi'] == '279' ? ' selected="selected"' : '', '>279</option>
<option', @$context['member']['options']['teknoromi'] == '280' ? ' selected="selected"' : '', '>280</option>
<option', @$context['member']['options']['teknoromi'] == '281' ? ' selected="selected"' : '', '>281</option>
<option', @$context['member']['options']['teknoromi'] == '282' ? ' selected="selected"' : '', '>282</option>
<option', @$context['member']['options']['teknoromi'] == '283' ? ' selected="selected"' : '', '>283</option>
<option', @$context['member']['options']['teknoromi'] == '284' ? ' selected="selected"' : '', '>284</option>
<option', @$context['member']['options']['teknoromi'] == '285' ? ' selected="selected"' : '', '>285</option>
<option', @$context['member']['options']['teknoromi'] == '286' ? ' selected="selected"' : '', '>286</option>
<option', @$context['member']['options']['teknoromi'] == '287' ? ' selected="selected"' : '', '>287</option>
<option', @$context['member']['options']['teknoromi'] == '288' ? ' selected="selected"' : '', '>288</option>
<option', @$context['member']['options']['teknoromi'] == '289' ? ' selected="selected"' : '', '>289</option>
<option', @$context['member']['options']['teknoromi'] == '290' ? ' selected="selected"' : '', '>290</option>
<option', @$context['member']['options']['teknoromi'] == '291' ? ' selected="selected"' : '', '>291</option>
<option', @$context['member']['options']['teknoromi'] == '292' ? ' selected="selected"' : '', '>292</option>
<option', @$context['member']['options']['teknoromi'] == '293' ? ' selected="selected"' : '', '>293</option>
<option', @$context['member']['options']['teknoromi'] == '294' ? ' selected="selected"' : '', '>294</option>
<option', @$context['member']['options']['teknoromi'] == '295' ? ' selected="selected"' : '', '>295</option>
<option', @$context['member']['options']['teknoromi'] == '296' ? ' selected="selected"' : '', '>296</option>
<option', @$context['member']['options']['teknoromi'] == '297' ? ' selected="selected"' : '', '>297</option>
<option', @$context['member']['options']['teknoromi'] == '298' ? ' selected="selected"' : '', '>298</option>
<option', @$context['member']['options']['teknoromi'] == '299' ? ' selected="selected"' : '', '>299</option>
...
// Veo Favori Silah 1
  if (!empty($context['profile_fields']))
		echo '
					</dl><dl><b>Favori Silah [1]:</b>
                              <dd><select name="default_options[veo-fav-weapon]">                           
<option', @$context['member']['options']['veo-fav-weapon'] == '1' ? ' selected="selected"' : '', '>1</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '2' ? ' selected="selected"' : '', '>2</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '3' ? ' selected="selected"' : '', '>3</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '4' ? ' selected="selected"' : '', '>4</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '5' ? ' selected="selected"' : '', '>5</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '6' ? ' selected="selected"' : '', '>6</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '7' ? ' selected="selected"' : '', '>7</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '8' ? ' selected="selected"' : '', '>8</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '9' ? ' selected="selected"' : '', '>9</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '10' ? ' selected="selected"' : '', '>10</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '11' ? ' selected="selected"' : '', '>11</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '12' ? ' selected="selected"' : '', '>12</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '13' ? ' selected="selected"' : '', '>13</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '14' ? ' selected="selected"' : '', '>14</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '15' ? ' selected="selected"' : '', '>15</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '16' ? ' selected="selected"' : '', '>16</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '17' ? ' selected="selected"' : '', '>17</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '18' ? ' selected="selected"' : '', '>18</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '19' ? ' selected="selected"' : '', '>19</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '20' ? ' selected="selected"' : '', '>20</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '21' ? ' selected="selected"' : '', '>21</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '22' ? ' selected="selected"' : '', '>22</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '23' ? ' selected="selected"' : '', '>23</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '24' ? ' selected="selected"' : '', '>24</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '25' ? ' selected="selected"' : '', '>25</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '26' ? ' selected="selected"' : '', '>26</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '27' ? ' selected="selected"' : '', '>27</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '28' ? ' selected="selected"' : '', '>28</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '29' ? ' selected="selected"' : '', '>29</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '30' ? ' selected="selected"' : '', '>30</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '31' ? ' selected="selected"' : '', '>31</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '32' ? ' selected="selected"' : '', '>32</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '33' ? ' selected="selected"' : '', '>33</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '34' ? ' selected="selected"' : '', '>34</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '35' ? ' selected="selected"' : '', '>35</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '36' ? ' selected="selected"' : '', '>36</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '37' ? ' selected="selected"' : '', '>37</option>
<option', @$context['member']['options']['veo-fav-weapon'] == '38' ? ' selected="selected"' : '', '>38</option>



                              </select></dd>
  ', !empty($context['member']['options']['veo-fav-weapon']) ? '' . $context['member']['options']['veo-fav-weapon'] . '' : '', '</dl>';  
  if (!empty($context['profile_fields']))
		echo '
					</dl><dl><b>Favori Silah [2]:</b>
                              <dd><select name="default_options[veo-fav-weapon2]">                           
<option', @$context['member']['options']['veo-fav-weapon2'] == '1' ? ' selected="selected"' : '', '>1</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '2' ? ' selected="selected"' : '', '>2</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '3' ? ' selected="selected"' : '', '>3</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '4' ? ' selected="selected"' : '', '>4</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '5' ? ' selected="selected"' : '', '>5</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '6' ? ' selected="selected"' : '', '>6</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '7' ? ' selected="selected"' : '', '>7</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '8' ? ' selected="selected"' : '', '>8</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '9' ? ' selected="selected"' : '', '>9</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '10' ? ' selected="selected"' : '', '>10</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '11' ? ' selected="selected"' : '', '>11</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '12' ? ' selected="selected"' : '', '>12</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '13' ? ' selected="selected"' : '', '>13</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '14' ? ' selected="selected"' : '', '>14</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '15' ? ' selected="selected"' : '', '>15</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '16' ? ' selected="selected"' : '', '>16</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '17' ? ' selected="selected"' : '', '>17</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '18' ? ' selected="selected"' : '', '>18</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '19' ? ' selected="selected"' : '', '>19</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '20' ? ' selected="selected"' : '', '>20</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '21' ? ' selected="selected"' : '', '>21</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '22' ? ' selected="selected"' : '', '>22</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '23' ? ' selected="selected"' : '', '>23</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '24' ? ' selected="selected"' : '', '>24</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '25' ? ' selected="selected"' : '', '>25</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '26' ? ' selected="selected"' : '', '>26</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '27' ? ' selected="selected"' : '', '>27</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '28' ? ' selected="selected"' : '', '>28</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '29' ? ' selected="selected"' : '', '>29</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '30' ? ' selected="selected"' : '', '>30</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '31' ? ' selected="selected"' : '', '>31</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '32' ? ' selected="selected"' : '', '>32</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '33' ? ' selected="selected"' : '', '>33</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '34' ? ' selected="selected"' : '', '>34</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '35' ? ' selected="selected"' : '', '>35</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '36' ? ' selected="selected"' : '', '>36</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '37' ? ' selected="selected"' : '', '>37</option>
<option', @$context['member']['options']['veo-fav-weapon2'] == '38' ? ' selected="selected"' : '', '>38</option>



                              </select></dd>
  ', !empty($context['member']['options']['veo-fav-weapon2']) ? '' . $context['member']['options']['veo-fav-weapon2'] . '' : '', '</dl>'; 
