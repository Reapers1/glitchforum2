	...
	while ($message = $context['get_message']())
	{
		...
		echo '
				...
				if (isset($message['member']['group_id']))  {
					...
					case '1':
					   $veobg = 'background-image: url(https://i.hizliresim.com/W7LPW2.png);color: #fff;';//admin grubu için renk ayarları
						break;
					case '2':
					   $veobg = 'background-image: url(https://i.hizliresim.com/W7LPW2.png);color: #fff;';//global mod için renk ayarları
						break;
				 case '0':
					   $veobg = 'background-image: url(https://i.hizliresim.com/W7LPW2.png);color: #fff;';//normal üyeler için renk ayarları
						 break;
				 default:
				   $veobg = 'background-image: url(https://i.hizliresim.com/W7LPW2.png);color: #fff;';//grub listesinde olmayanlar renk ayarları
				 break;
					 }
				 }
				 else {$veobg= 'background-image: url(https://i.hizliresim.com/W7LPW2.png);color: #fff;';}
				 echo '
      ...
      echo '          <div class="left_colum"> <!--Inicio segunda columna-->
		...
		if (!$message['member']['is_guest'])
		{
			...
			//Veo Favori Karakter
			 ...
			 echo '          </ul>';
					// Veo Favori Silah 1
			if (empty($message['member']['options']['veo-fav-weapon'])) {
			$message['member']['options']['veo-fav-weapon']='0';
			}
			echo '
						<div class="veo-fav-weapon">
			<img src="', $settings['default_images_url'], '/silahlar/', $message['member']['options']['veo-fav-weapon'], '.png" /></div> ';
			if (empty($message['member']['options']['veo-fav-weapon2'])) {
			$message['member']['options']['veo-fav-weapon2']='0';
			}
			echo '
						<div class="veo-fav-weapon2">
			<img src="', $settings['default_images_url'], '/silahlar/', $message['member']['options']['veo-fav-weapon2'], '.png" /></div> ';
			echo'
                  </div>';
				  //Veo Favori Karakter
			...
			<img src="', $settings['default_images_url'], '/karakter/', $message['member']['options']['teknoromi'], '.png" /></div> ';
			echo'</div>
		...
		echo '
				  ...
				  <div class="veo-api">
				<div class="veo-api-karakter">Nickname: Karakter Bulunamadı</div>
				<div class="veo-api-level">Level: N/A</div>
				<div class="veo-api-score">Skor: N/A</div>
				<div class="veo-api-gang">Birlik: N/A</div>
				</div>
		...
		echo '
		 ...
		 margin-left: 6px; display: -moz-inline-block; display:inline-block; padding:1px 20px 0 5px; height:15px;) 
		 no-repeat top right; } html .fb_share_button:hover { color:#fff;  text-decoration:none; } </style> <a href="http://www.facebook.com/share.php?u=<url>" class="fb_share_button" onclick="return fbs_click()" target="_blank" style="text-decoration:none;"><i class="fa fa-facebook-official" aria-hidden="true"></i></a>';
